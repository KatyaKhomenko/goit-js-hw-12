import{a as p,i as l,S as x}from"./assets/vendor-LMTxnMPs.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const f of s.addedNodes)f.tagName==="LINK"&&f.rel==="modulepreload"&&a(f)}).observe(document,{childList:!0,subtree:!0});function r(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(e){if(e.ep)return;e.ep=!0;const s=r(e);fetch(e.href,s)}})();let i=1,c=15;const m=document.querySelector(".load-more-button"),h="45438776-ecb5ad08617ff6ac6ebcc304f";p.defaults.baseURL="https://pixabay.com/api";async function L(o){i=1,m.style.display="none";try{const t=await p.get("/",{params:{key:h,q:o,image_type:"photo",orientation:"horizontal",safesearch:!0,page:i,per_page:c}});return i++,m.style.display="block",t.data}catch(t){l.show({message:t.message,messageColor:"#fff",color:"#EF4040",position:"topCenter",timeout:5e3})}}async function C(o){try{const t=await p.get("/",{params:{key:h,q:o,image_type:"photo",orientation:"horizontal",safesearch:!0,page:i,per_page:c}});return i++,t.data}catch(t){l.show({message:t.message,messageColor:"#fff",color:"#EF4040",position:"topCenter",timeout:5e3})}}function g(o){const t=document.querySelector("ul");t.classList.add("gallery");const r=o.map(e=>`
